...
lmx=[1500 1600 1700 1800 1900 2000 2200 2400 2600 2800 3000 4000 5000 6000 7000 8000 9000 10000 11000 12000 13000];
for iter=1:length(lmx)
    iter
...
%% LOAD MODEL
lambda2_max  = lmx(iter);%$/pu.h
lambda3_max  = lmx(iter);%$/pu.h
...
PBT(iter,1)=-elasticity2_avg;
PBT(iter,2)=-NPER;
PBT(iter,3)=TIR;
PBT(iter,4)=-BCratio;
PBT(iter,5)=mean(lambda1)/100;
figure
scatter(PBT(:,1),PBT(:,2))
figure
scatter(PBT(:,1),PBT(:,3))
